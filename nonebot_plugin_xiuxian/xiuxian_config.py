...
class XiuConfig:
    ...
    def __init__(self):
        ...
        self.sql_user_xiuxian = ["level_up_rate", "sect_id", "sect_position", "spirit_rate", "spirit_type", "hp", "mp", "atk", "atkpractice",
                           "sect_task", "sect_contribution", "sect_history_contribution", "sect_elixir_get", "blessed_spot_flag", "blessed_spot_name"]  # 数据库字段校验
